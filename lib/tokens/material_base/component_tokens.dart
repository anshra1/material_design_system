...
import 'package:material_design_system/tokens/typography_tokens.dart';
  ...
  factory ComponentTokens.from({
    ...
    return ComponentTokens(
      ...
      surface: SurfaceTokens(
        surfaceContainerColor: system.surface,
        surfaceContainerLowColor: system.surface,
        surfaceContainerHighColor: system.surface,
        surfaceContainerHighestColor: system.surface,
      ),
