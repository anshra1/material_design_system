...
class PrimaryButton extends StatelessWidget {
  ...
  ///
  /// TODO: Confirm precedence between explicit widget props and overrideConfig.
  ...
  Widget build(BuildContext context) {
    ...
    final OutlinedBorder? effectiveShape = mergedConfig.shape is OutlinedBorder
        ? mergedConfig.shape as OutlinedBorder?
        : RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0));
    final double iconGap = mergedConfig.iconGap ?? 8.0;
