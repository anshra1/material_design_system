...
/// The public-facing widget for a secondary button.
...
class SecondaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final baseConfig = AppButtonThemes.secondary(context);
    ...
    if (finalShape != null && finalShape is! OutlinedBorder) {
      throw ArgumentError(
        'SecondaryButton received a shape of type ${finalShape.runtimeType}, which is not an OutlinedBorder. '
